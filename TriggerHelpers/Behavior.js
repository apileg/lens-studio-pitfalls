...
//
// Changelog:
// - Fixed bug at line 506 by azerum, apileg
//
    ...
    var globalTriggerSystem = (function() {
        ...
        return {
            ...
            sendMessage: function(key) {   
                //Array can be modified by callback's while we are still iterating
                //(callback can unsubscribe from trigger while executing, this will remove one element
                //from array). This can lead to nasty bugs (i.e. some elements might be skipped while iterating). 
                //To protect ourselves, simply copy the array before iterating
                
                const listenersCopy = getListeners(key).slice();
                listenersCopy.forEach(safeCall);
            },
        };
    })();
